  ...
  <q-page>
    ...
    <div class="row justify-center">
      <div class="col-12 col-md-8 text-body1">
        ...
        <strong>Unsurprisingly, this major global disruption is leading to reduced trade locally, regionally and globally,</strong> as supply chains are disrupted,
        ...
        <q-space class="q-ma-md"/>
        <strong>In 2020, the global volume of imports of goods and services decreased around 8.9% and the volume of exports decreased around 8.0% compared to 2019.</strong>
      </div>
    </div>
    ...
    <div class="row justify-center">
      <div class="col-12 col-md-8">
        <div class="text-body1 q-mt-lg q-mb-lg">
          <strong>With 80 per cent of global trade in goods carried by sea, maritime port traffic can reflect the
            pandemic’s progress in finer temporal resolution.</strong> For the first
    ...
    <div class="row justify-center">
      <div class="col-12 col-md-8">
        <div class="text-body1 q-mt-lg q-mb-lg">
          <strong>The impact of the virus varies from regions and countries.</strong>
        According to UNCTAD, China
        and the Republic of Korea are both forecast to enjoy positive, albeit weak, positive growth in GDP in
        2020, at +1.3% and +0.1%, respectively. The Americas, both developed and
        developing, are expected to experience negative output growth in 2020.
        <q-space class="q-ma-md"/>
        Regarding the trade volume, you may use the slider in the map to explore some regions of which the trade volume was impacted largely between 2019 and 2020.
        </div>
      </div>
    </div>
    <div class="row">
